...
```{r}
ggplot(df_10000, aes(x = Sample_Size, y = Type_I_Error_Rate, color = Distribution)) +
  geom_line() +
  geom_point() +
  labs(title = "Type I Error Rate by Sample 
       Size and Distribution (m=10000)", x = "Sample Size", y = "Type I Error Rate") +
  theme_minimal()
```
